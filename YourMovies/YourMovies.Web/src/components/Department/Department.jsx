...
import { createApiEndpoint, EndPointsDepartment } from "../../api";
...
function Department() {
    ...
    const handleEdit = (id) => {
      handleShow();
      createApiEndpoint(EndPointsDepartment.getById).fetchById(id)
      .then((result) => {
    ...
    const handleDelete = (id) => {
      if (window.confirm("Are you sure to delete this production company") == true) {
        createApiEndpoint(EndPointsDepartment.delete).delete(id)
        .then((result) => {
    ...
    const handleUpdate = () => {    
      ...
      createApiEndpoint(EndPointsDepartment.update).update(data)
      .then((result) => {
        getData();
        clear();
    ...
    const handleSave = () => {
      ...
      createApiEndpoint(EndPointsDepartment.create).create(data)
      .then((result) => {
        getData();
        clear();
